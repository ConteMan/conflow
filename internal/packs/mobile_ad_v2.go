		...
		Schema: Schema{
			...
			Entities: []EntitySchema{
				...
				{Name: "frequency_policy", Fields: []FieldSchema{
					field("cooldown", FieldTypeObject, true, true, "null", "冷却时间", "两次成功展示之间的最短时间。", "object", "频控", 0, FieldValidation{}),
					field("interval", FieldTypeObject, true, true, "null", "展示间隔", "时间或离散项目间隔。", "object", "频控", 1, FieldValidation{}),
					field("max_count", FieldTypeObject, true, true, "null", "次数上限", "session 或 day 的次数上限。", "object", "频控", 2, FieldValidation{}),
					field("shift_count", FieldTypeObject, true, true, "null", "分时上限", "本地上午和下午的次数上限。", "object", "频控", 3, FieldValidation{}),
				...
				{Name: "placement", Fields: []FieldSchema{
					...
					field("enabled_switch_id", FieldTypeReference, true, false, `""`, "启用开关", "引用 feature_switch 实体 ID。", "select", "投放", 3, FieldValidation{}),
					...
					field("cache_ttl", FieldTypeObject, true, true, "null", "缓存有效期", "缓存的有效期。", "object", "投放", 9, FieldValidation{}),
					field("fallback_behavior", FieldTypeString, true, false, `""`, "兜底行为", "广告不可用时的业务动作。", "input", "投放", 10, FieldValidation{}),
				}},
