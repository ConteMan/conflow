...
type Mode = "ready" | "preview" | "invalid" | "stale";

async function mockReleaseAPI(page: Page, mode: Mode = "ready") {
  let planRequests = 0;
  let operationReads = 0;
  const planID = mode === "invalid" ? "plan_invalid" : mode === "preview" ? "plan_preview" : "plan_ready";
